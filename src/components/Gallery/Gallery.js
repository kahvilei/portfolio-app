        ...
        return <div style={{position: 'static', paddingLeft: '60px' , top: '0px'}}>
            <div className = "gallery-collumn" style={{padding: '.25vw', verticalAlign: 'top', position: 'relative', display: "inline-table", width: '29vw', height: '100%'}}> 
                ...
                <h1 style = {{ margin: '0', userSelect: 'none', padding: "20px", fontSize:"5vw", fontWeight: '200'}}>gallery</h1>
                    <p style = {{ userSelect: 'none', margin: "20px", width:"90%", fontWeight: '200'}}>here is a collection of illustrations that I've completed for personal projects and clients <br></br> <br></br>pan and zoom to interact</p>
                </div>
                <div style={{transition: '0.1s',position: 'relative', display: 'block' }}>{this.renderItem("https://kathrynhuff.com/assets/gallery/01.jpg","one","ship")}</div>
                <div style={{transition: '0.1s',position: 'relative', display: 'block'}}>{this.renderItem("https://kathrynhuff.com/assets/gallery/02.jpg","two","2")}</div>
                
            </div>
            <div className = "gallery-collumn" style={{padding: '.25vw',  verticalAlign: 'top',position: 'relative', display: "inline-table", width: '29vw', height: '100%'}}> 
                <div style={{transition: '0.1s',position: 'relative', display: 'block'}}>{this.renderItem("https://kathrynhuff.com/assets/gallery/03.jpg","three","babystorm")}</div>
                <div style={{transition: '0.1s',position: 'relative', display: 'block'}}>{this.renderItem("https://kathrynhuff.com/assets/gallery/04.jpg","four","a dream")}</div>
                <div style={{transition: '0.1s',position: 'relative', display: 'block'}}>{this.renderItem("https://kathrynhuff.com/assets/gallery/05.jpg","five","5")}</div>
                <div style={{transition: '0.1s',position: 'relative', display: 'block'}}>{this.renderItem("https://kathrynhuff.com/assets/gallery/06.jpg","six","6") }</div>
            </div>
            <div className = "gallery-collumn" style={{padding: '.25vw',  verticalAlign: 'top',position: 'relative', display: "inline-table", width: '29vw', height: '100%'}}> 
                <div style={{transition: '0.1s',position: 'relative', display: 'block'}}>{this.renderItem("https://kathrynhuff.com/assets/gallery/07.png","seven","6")}</div>
                <div style={{transition: '0.1s',position: 'relative', display: 'block'}}>{this.renderItem("https://kathrynhuff.com/assets/gallery/08.jpg","eight","6")}</div>
                <div style={{transition: '0.1s',position: 'relative', display: 'block'}}>{this.renderItem("https://kathrynhuff.com/assets/gallery/09.png","nine","6")}</div>
            </div>

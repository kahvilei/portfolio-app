...
class Project extends React.Component{
    ...
    render(){
        return<div id = "content" style = {{marginTop: '0px',paddingTop: '0px', width: '100vw'}}>
                ...
                <div id = "projects-wrapper" style = {{paddingTop: '0vw', margin: '0 0 2vw 25vw'}}>
